...
function HeroCyberethic() {
  return (
    <>
      ...
      <svg viewBox="0 0 1440 185" preserveAspectRatio="none" fill="#001f4d" version="1.1" xmlns="http://www.w3.org/2000/svg" className="d-block text-primary" width="100%" height="160" style={{ boxShadow: '0 4px 6px rgba(0, 0, 0, 0.3)' }}>
